...
# background
background = pygame.image.load('stars at night.jpeg')
...
def show_score(x, y):
    score = font.render("score:" + str(score_value), True, (120, 255, 100))
...
while running:
    ...
    # checking boundaries for spaceship so it doesnt go out of bounds.
