...
class user:
    ...
    def display_balance(self): # the balance will print itself when called, using 'self' parameter.
        print(self)

    def transfer_money(self, other_user, amount): # user account balance will transer money.
        self.account_balance -= amount # balance is transferred using the 'other_user' parameter. 
        other_user.account_balance += amount

guido = user("Guido van Rossum", "guido@python.com")   # this is a user with two parameters. 
monty = user("Monty Python", "monty@python.com")   # this is a user with two parameters.
michael = user("Michael Dojo", "michael@codingdojo.com") # this is a user with two parameters.
anna = user("Anna Dojo", "anna@codingdojo.com") # this is a user with two parameters.
judge = user("Judge Fudge", "judge.smith@charter.net") # this is a user with two parameters.
### to add more parameters to a user you must first update the class at the to to include the parameter you wish to add. Dog.
