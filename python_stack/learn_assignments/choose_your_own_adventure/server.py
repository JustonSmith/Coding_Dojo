...
#     print("You're watching TV home alone, and the power in your bedroom goes out. Do you go downstairs to check it out?")
...
# else:
#     print("You close your bedroom door and lock it. You reach for your phone but realize you left it in the bathroom. Do you go look for it?")
#     phone = input("yes or no")
#     while phone == "no":
#         print("You dont have any options. Go look for your phone, coward.")
#         phone = input ("yes or no?")
#     print("You open the door and tiptoe into the bathroom. You grab your phone and hear another noise downstairs. Do you want to check it out?")
# answer_2 = input("yes or no?")

# if answer_2 == 'yes':
#     print("You pick up your sister's softball bat. Do you want to head towards the noise?")
...
# else:
#     print("Wise choice. You dial 911 and wait for the authorities to arrive.")
#     print("...but what a boring story. Next time investigate.")
...
import render_template, redirect, time # imports a module to add a pause
...
# Story is broken up into sections
